...
export const enSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadKubernetes': 'Failed to load Kubernetes resources',
  ...
  'systemManager.errors.loadKubernetesLogs': 'Failed to load pod logs',
  'systemManager.errors.loadKubernetesDescribe': 'Failed to describe pod',
  ...
  'systemManager.kubernetes.unavailable': 'kubectl is not available on this host',
  'systemManager.kubernetes.loading': 'Loading pods…',
  'systemManager.kubernetes.loadingDeployments': 'Loading deployments…',
  'systemManager.kubernetes.loadingEvents': 'Loading events…',
  'systemManager.kubernetes.loadingDetail': 'Loading…',
  'systemManager.kubernetes.empty': 'No pods found.',
  'systemManager.kubernetes.emptyDeployments': 'No deployments found.',
  'systemManager.kubernetes.emptyEvents': 'No events found.',
  'systemManager.kubernetes.emptyDetail': 'No output.',
  'systemManager.kubernetes.search': 'Search pods…',
  'systemManager.kubernetes.searchDeployments': 'Search deployments…',
  ...
  'systemManager.kubernetes.namespaceAll': 'All namespaces',
  'systemManager.kubernetes.context': 'Context: {{name}}',
  'systemManager.kubernetes.contextUnknown': 'Context: —',
  'systemManager.kubernetes.logs': 'Logs',
  'systemManager.kubernetes.describe': 'Describe',
  'systemManager.kubernetes.logsTitle': 'Pod logs (last 200 lines)',
  'systemManager.kubernetes.describeTitle': 'kubectl describe',
  'systemManager.kubernetes.readOnlyNote': 'Read-only MVP: list / logs / describe. No apply, delete, or exec yet.',
  'systemManager.kubernetes.writeNote': 'Delete pod and scale deployment require confirmation. Agent/MCP write tools also require confirm-mode approval.',
  'systemManager.kubernetes.delete': 'Delete',
  'systemManager.kubernetes.deleteTitle': 'Delete pod',
  'systemManager.kubernetes.deleteConfirm': 'Delete pod {{name}}? This cannot be undone from MagiesTerminal.',
  'systemManager.kubernetes.scale': 'Scale',
  'systemManager.kubernetes.scaleTitle': 'Scale deployment',
  'systemManager.kubernetes.scaleConfirm': 'Scale',
  ...
  'systemManager.kubernetes.scaleReplicas': 'Replicas',
  'systemManager.kubernetes.scaleReplicasPlaceholder': '3',
  'systemManager.kubernetes.scaleInvalidName': 'Enter a valid DNS-1123 name (lowercase letters, digits, hyphens).',
  'systemManager.kubernetes.scaleInvalidReplicas': 'Replicas must be an integer between 0 and 1000.',
  ...
  'systemManager.overview.live': 'Live',
  'systemManager.overview.updated': 'Updated',
  'systemManager.overview.telemetry': 'Telemetry',
  'systemManager.overview.samples': '{{count}} samples',
