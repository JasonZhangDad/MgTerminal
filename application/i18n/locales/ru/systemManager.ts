...
export const ruSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadKubernetes': "Не удалось загрузить ресурсы Kubernetes",
  'systemManager.errors.loadKubernetesLogs': "Не удалось загрузить логи pod",
  'systemManager.errors.loadKubernetesDescribe': "Не удалось выполнить describe pod",
  ...
  'systemManager.overview.live': 'Онлайн',
  'systemManager.overview.updated': 'Обновлено',
  'systemManager.overview.telemetry': 'Телеметрия',
  'systemManager.overview.samples': '{{count}} выборок',
  ...
  'systemManager.kubernetes.unavailable': "kubectl недоступен на этом хосте",
  'systemManager.kubernetes.loading': "Загрузка pod…",
  'systemManager.kubernetes.loadingDeployments': "Загрузка deployment…",
  'systemManager.kubernetes.loadingDetail': "Загрузка…",
  'systemManager.kubernetes.empty': "Pod не найдены.",
  'systemManager.kubernetes.emptyDeployments': "Deployment не найдены.",
  'systemManager.kubernetes.emptyDetail': "Нет вывода.",
  'systemManager.kubernetes.search': "Поиск pod…",
  'systemManager.kubernetes.searchDeployments': "Поиск deployment…",
  'systemManager.kubernetes.resourcePods': "Pods",
  'systemManager.kubernetes.resourceDeployments': "Deployments",
  'systemManager.kubernetes.namespaceAll': "Все namespace",
  'systemManager.kubernetes.context': "Контекст: {{name}}",
  'systemManager.kubernetes.contextUnknown': "Контекст: —",
  'systemManager.kubernetes.logs': "Логи",
  'systemManager.kubernetes.describe': "Describe",
  'systemManager.kubernetes.logsTitle': "Логи pod (последние 200 строк)",
  'systemManager.kubernetes.describeTitle': "kubectl describe",
  'systemManager.kubernetes.readOnlyNote': "MVP только чтение: list / logs / describe. Пока без apply, delete и exec.",
  'systemManager.kubernetes.writeNote': "Удаление pod и scale deployment требуют подтверждения. Записи Agent/MCP — тоже.",
  'systemManager.kubernetes.delete': "Удалить",
  'systemManager.kubernetes.deleteTitle': "Удалить pod",
  'systemManager.kubernetes.deleteConfirm': "Удалить pod {{name}}? Это нельзя отменить в MagiesTerminal.",
  ...
  'systemManager.kubernetes.scaleInvalidName': "Введите допустимое DNS-1123 имя (строчные буквы, цифры, дефисы).",
  'systemManager.kubernetes.scaleInvalidReplicas': "Replicas должно быть целым числом от 0 до 1000.",
