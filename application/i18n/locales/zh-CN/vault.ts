...
export const zhCNVaultMessages: Messages = {
  ...
  'terminal.toolbar.sendSerialHex': '发送十六进制',
  'terminal.serialHex.title': '发送十六进制字节',
  'terminal.serialHex.description': '字节将按原样写入设备，不经过字符集转换。',
  'terminal.serialHex.input': '十六进制',
  'terminal.serialHex.byteCount': '{count} 字节',
  'terminal.serialHex.send': '发送',
  'terminal.serialHex.error.empty': '请输入至少一个十六进制字节。',
  'terminal.serialHex.error.odd_length': '十六进制需成对出现——缺少一位。',
  'terminal.serialHex.error.invalid_hex': '只允许 0-9 和 A-F。',
  ...
  'sftp.conflict.hint.existingNewer': "已有文件的修改时间更新。",
  'sftp.conflict.hint.incomingNewer': "传入文件的修改时间更新。",
  'sftp.conflict.hint.partialOverlap': "已有文件体积小于传入文件，可能是未完成传输。可点「续传」从已有字节继续，或「替换」整文件重写。",
  'sftp.conflict.action.stop': '停止',
  'sftp.conflict.action.skip': '跳过',
  'sftp.conflict.action.resume': "续传",
