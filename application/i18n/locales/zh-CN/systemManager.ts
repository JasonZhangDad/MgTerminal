...
export const zhCnSystemManagerMessages: Messages = {
  ...
  'systemManager.errors.loadDockerCompose': '加载 Docker Compose 项目失败',
  'systemManager.errors.loadKubernetes': "加载 Kubernetes 资源失败",
  'systemManager.errors.loadKubernetesEvents': '加载 Kubernetes 事件失败',
  'systemManager.errors.loadKubernetesRollout': '加载 Deployment Rollout 失败',
  'systemManager.errors.loadKubernetesLogs': "加载 Pod 日志失败",
  'systemManager.errors.loadKubernetesDescribe': "describe Pod 失败",
  ...
  'systemManager.overview.live': '实时',
  'systemManager.overview.updated': '更新',
  'systemManager.overview.telemetry': '实时曲线',
  'systemManager.overview.samples': '{{count}} 个采样点',
  ...
  'systemManager.kubernetes.unavailable': "此主机上未安装 kubectl",
  'systemManager.kubernetes.loading': "正在加载 Pod…",
  'systemManager.kubernetes.loadingDeployments': "正在加载 Deployment…",
  'systemManager.kubernetes.loadingEvents': '正在加载事件…',
  'systemManager.kubernetes.loadingDetail': "加载中…",
  'systemManager.kubernetes.empty': "未找到 Pod。",
  'systemManager.kubernetes.emptyDeployments': "未找到 Deployment。",
  'systemManager.kubernetes.emptyEvents': '未找到事件。',
  'systemManager.kubernetes.emptyDetail': "无输出。",
  'systemManager.kubernetes.search': "搜索 Pod…",
  'systemManager.kubernetes.searchDeployments': "搜索 Deployment…",
  'systemManager.kubernetes.searchEvents': '搜索事件…',
  ...
  'systemManager.kubernetes.namespaceAll': "全部命名空间",
  'systemManager.kubernetes.context': "上下文：{{name}}",
  'systemManager.kubernetes.contextUnknown': "上下文：—",
  'systemManager.kubernetes.logs': "日志",
  'systemManager.kubernetes.describe': "描述",
  'systemManager.kubernetes.logsTitle': "Pod 日志（最近 200 行）",
  'systemManager.kubernetes.describeTitle': "kubectl describe",
  'systemManager.kubernetes.readOnlyNote': "只读 MVP：列表 / 日志 / describe。暂不支持 apply、delete 或 exec。",
  'systemManager.kubernetes.writeNote': "删除 Pod 与伸缩 Deployment 需确认。Agent/MCP 写操作同样需要确认模式审批。",
  'systemManager.kubernetes.delete': "删除",
  'systemManager.kubernetes.deleteTitle': "删除 Pod",
  'systemManager.kubernetes.deleteConfirm': "确定删除 Pod {{name}}？此操作无法在 MagiesTerminal 中撤销。",
  'systemManager.kubernetes.scale': "伸缩",
  'systemManager.kubernetes.scaleTitle': "伸缩 Deployment",
  'systemManager.kubernetes.scaleConfirm': "伸缩",
  'systemManager.kubernetes.scaleDeployment': "Deployment",
  'systemManager.kubernetes.scaleDeploymentPlaceholder': "my-app",
  'systemManager.kubernetes.scaleNamespace': "命名空间",
  'systemManager.kubernetes.scaleReplicas': "副本数",
  'systemManager.kubernetes.scaleReplicasPlaceholder': "3",
  'systemManager.kubernetes.scaleInvalidName': "请输入有效的 DNS-1123 名称（小写字母、数字、连字符）。",
  'systemManager.kubernetes.scaleInvalidReplicas': "副本数必须是 0–1000 的整数。",
  'systemManager.kubernetes.rollout': 'Rollout',
  'systemManager.kubernetes.rolloutStatus': '状态',
  'systemManager.kubernetes.rolloutHistory': '历史',
  'systemManager.kubernetes.rolloutRestart': '重启 Rollout',
  'systemManager.kubernetes.rolloutRestartConfirm': '确定重启 Deployment {{name}} 的 Rollout？',
  'systemManager.kubernetes.exec': 'Exec',
  'systemManager.kubernetes.execTitle': '进入 {{name}}',
  'systemManager.kubernetes.container': '容器',
  'systemManager.kubernetes.containerOptional': '可选容器名称',
  'systemManager.kubernetes.portForward': '端口转发',
  'systemManager.kubernetes.portForwardTitle': '转发 {{name}} 的端口',
  'systemManager.kubernetes.localPort': '目标主机本地端口',
  'systemManager.kubernetes.remotePort': 'Pod 端口',
  'systemManager.kubernetes.invalidExecTarget': 'Pod 或容器名称无效。',
  'systemManager.kubernetes.invalidPorts': '端口必须是 1–65535 的整数。',
  ...
  'systemManager.docker.compose.search': '搜索 Compose 项目…',
  'systemManager.docker.compose.meta': '{{count}} 个项目',
  'systemManager.docker.compose.loading': '正在加载 Compose 项目…',
  'systemManager.docker.compose.empty': '未找到 Compose 项目',
  'systemManager.docker.compose.loadingServices': '正在加载 Compose 服务…',
  'systemManager.docker.compose.emptyServices': '未找到 Compose 服务',
  'systemManager.docker.compose.noConfig': '未报告配置文件',
  'systemManager.docker.compose.up': '启动',
  'systemManager.docker.compose.down': '停止并移除',
  'systemManager.docker.compose.restart': '重启',
  'systemManager.docker.compose.start': '启动',
  'systemManager.docker.compose.stop': '停止',
  'systemManager.docker.compose.confirmTitle': 'Docker Compose 操作',
  'systemManager.docker.compose.confirm': '确定对 Compose 项目 {{name}} 执行“{{action}}”？',
